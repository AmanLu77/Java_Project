...
public class GameManager {
    ...
    private void endGame() {
        ...
        javafx.scene.text.Text endGameWintxt = new javafx.scene.text.Text("YOU WIN! press ESC to restart");
        javafx.scene.text.Text endGameOvertxt = new javafx.scene.text.Text("GAME OVER :( press ESC to restart");

        root.getChildren().remove(this.scoreBoard.score);
        root.getChildren().remove(this.scoreBoard.lifes);

        if (isSuccess) {
            endGameWintxt.setX(BarObstacle.THICKNESS * 14);
            endGameWintxt.setY(BarObstacle.THICKNESS * 27);
            endGameWintxt.setFont(Font.font("Arial", 38));
            endGameWintxt.setFill(Color.LIMEGREEN);
            root.getChildren().add(endGameWintxt);
        } else {
            endGameOvertxt.setX(BarObstacle.THICKNESS * 12);
            endGameOvertxt.setY(BarObstacle.THICKNESS * 27);
            endGameOvertxt.setFont(Font.font("Arial", 38));
            endGameOvertxt.setFill(Color.CRIMSON);
            root.getChildren().add(endGameOvertxt);
        }
    }
    ...
    public void generateGhosts() {
        this.ghosts.add(new Ghost(18.5 * BarObstacle.THICKNESS, 12.5 * BarObstacle.THICKNESS, Color.ORANGE, maze, this));
        this.ghosts.add(new Ghost(22.5 * BarObstacle.THICKNESS, 12.5 * BarObstacle.THICKNESS, Color.RED, maze, this));
        this.ghosts.add(new Ghost(28.5 * BarObstacle.THICKNESS, 12.5 * BarObstacle.THICKNESS, Color.VIOLET, maze, this));
        this.ghosts.add(new Ghost(28.5 * BarObstacle.THICKNESS, 9.5 * BarObstacle.THICKNESS, Color.CYAN, maze, this));
    }
